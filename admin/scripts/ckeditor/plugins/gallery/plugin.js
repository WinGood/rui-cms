CKEDITOR.plugins.add('gallery', {
	...
	onLoad: function () {
		CKEDITOR.addCss("img.cke_gallery{background-image: url(" + CKEDITOR.getUrl(this.path + "images/place-gall.png") + ");background-position: center center;background-repeat: no-repeat;border: 1px solid #a9a9a9;width: 80px;height: 80px;}");
		CKEDITOR.addCss("img.cke_slider{background-image: url(" + CKEDITOR.getUrl(this.path + "images/place-gall.png") + ");background-position: center center;background-repeat: no-repeat;border: 1px solid #a9a9a9;width: 80px;height: 80px;}");
	},
